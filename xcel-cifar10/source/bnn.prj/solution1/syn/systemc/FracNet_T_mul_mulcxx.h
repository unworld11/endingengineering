...
// ==============================================================
#ifndef __FracNet_T_mul_mulcxx__HH__
#define __FracNet_T_mul_mulcxx__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mul_mulcxx) {
    ...
    SC_CTOR(FracNet_T_mul_mulcxx):  ACMP_smul_su_U ("ACMP_smul_su_U") {
