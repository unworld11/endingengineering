...
// ==============================================================
#ifndef __FracNet_T_mul_mulcDy__HH__
#define __FracNet_T_mul_mulcDy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mul_mulcDy) {
    ...
    SC_CTOR(FracNet_T_mul_mulcDy):  ACMP_smul_us_U ("ACMP_smul_us_U") {
