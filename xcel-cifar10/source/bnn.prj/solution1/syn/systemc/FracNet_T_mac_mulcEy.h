...
// ==============================================================
#ifndef __FracNet_T_mac_mulcEy__HH__
#define __FracNet_T_mac_mulcEy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mac_mulcEy) {
    ...
    SC_CTOR(FracNet_T_mac_mulcEy):  simcore_mac_2_U ("simcore_mac_2_U") {
