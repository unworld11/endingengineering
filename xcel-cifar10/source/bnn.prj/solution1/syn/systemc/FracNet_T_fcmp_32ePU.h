...
// ==============================================================
#ifndef __FracNet_T_fcmp_32ePU__HH__
#define __FracNet_T_fcmp_32ePU__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_fcmp_32ePU) {
    ...
    SC_CTOR(FracNet_T_fcmp_32ePU):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
