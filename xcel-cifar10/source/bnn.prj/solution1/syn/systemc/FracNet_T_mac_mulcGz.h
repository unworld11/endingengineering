...
// ==============================================================
#ifndef __FracNet_T_mac_mulcGz__HH__
#define __FracNet_T_mac_mulcGz__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mac_mulcGz) {
    ...
    SC_CTOR(FracNet_T_mac_mulcGz):  simcore_mac_3_U ("simcore_mac_3_U") {
