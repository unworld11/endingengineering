...
// ==============================================================
#ifndef __FracNet_T_mul_muldbE__HH__
#define __FracNet_T_mul_muldbE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mul_muldbE) {
    ...
    SC_CTOR(FracNet_T_mul_muldbE):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
