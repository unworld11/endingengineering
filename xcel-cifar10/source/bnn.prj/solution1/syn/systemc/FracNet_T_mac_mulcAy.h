...
// ==============================================================
#ifndef __FracNet_T_mac_mulcAy__HH__
#define __FracNet_T_mac_mulcAy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mac_mulcAy) {
    ...
    SC_CTOR(FracNet_T_mac_mulcAy):  simcore_mac_0_U ("simcore_mac_0_U") {
