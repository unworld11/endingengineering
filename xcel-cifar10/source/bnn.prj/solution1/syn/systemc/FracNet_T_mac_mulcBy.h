...
// ==============================================================
#ifndef __FracNet_T_mac_mulcBy__HH__
#define __FracNet_T_mac_mulcBy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mac_mulcBy) {
    ...
    SC_CTOR(FracNet_T_mac_mulcBy):  simcore_mac_1_U ("simcore_mac_1_U") {
