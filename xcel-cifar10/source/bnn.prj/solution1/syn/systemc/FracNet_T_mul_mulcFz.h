...
// ==============================================================
#ifndef __FracNet_T_mul_mulcFz__HH__
#define __FracNet_T_mul_mulcFz__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_T_mul_mulcFz) {
    ...
    SC_CTOR(FracNet_T_mul_mulcFz):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
