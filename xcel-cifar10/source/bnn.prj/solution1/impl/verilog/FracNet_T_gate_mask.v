...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module FracNet_T_gate_mask_rom (
...
initial begin
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram0);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram1);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram2);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram3);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram4);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram5);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram6);
    $readmemh("./FracNet_T_gate_mask_rom.dat", ram7);
end
...
FracNet_T_gate_mask_rom FracNet_T_gate_mask_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
